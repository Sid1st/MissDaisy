...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://statusringtones:fV2rGirOqMMhE1Sg@clustersubham.gs81aas.mongodb.net/?retryWrites=true&w=majority&appName=ClusterSubham")
