...
#Your db channel Id
CHANNEL_ID = [int(channel) for channel in os.getenv('CHANNELS', '-1002182741200' '-1002219778296' '-1001580649184').split()]
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://subhamgupta992sg:UXRT66yXTlP7MTJt@cluster0.bza4jw6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
